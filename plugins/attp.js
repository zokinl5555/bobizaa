...
externalAdReply: {
title: 'Goru BOT ♥',
body: "بوت من تحرير حقوقك💖",
thumbnailUrl: 'https://telegra.ph/file/e8422fe13422c0cf1ae82.jpg',
sourceUrl: 'رابط حساب من عندك في السوشيال ميديا',
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})

    /*conn.sendFile(m.chat, 'menu.png', text.trim(), m, null, )
    /*conn.sendButton(m.chat, text.trim(), '▢ DyLux  ┃ ᴮᴼᵀ\n▢ Sígueme en Instagram\nرابط حساب من عندك في السوشيال ميديا', pp, [
      ['ꨄ︎ Apoyar', `${_p}donate`],
      ['⏍ Info', `${_p}botinfo`],
      ['⌬ Grupos', `${_p}gpdylux`]
    ],m, rpl)*/
